...
const UpdatePessoas = () => {
  ...
  const handleUpdatePessoas = async (event: React.FormEvent<HTMLFormElement>) => {
  ...
  return (
    <div>
      <h2>
        Atualização de Pessoa: {nome} - {rua} - {numero} - {complemento} - {documento} - {cidade_id} - {tipo_id}
      </h2>
      <form onSubmit={handleUpdatePessoas}>
        <div>
