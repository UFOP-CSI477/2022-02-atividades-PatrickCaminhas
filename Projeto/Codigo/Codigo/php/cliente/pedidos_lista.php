...
<meta charset="UTF-8">
    ...
    <title>iLanches - Lista de pedidos</title>
    ...
    <div class="offcanvas offcanvas-start text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link active fw-bolder" aria-current="page" href="pedidos_lista.php">Pedidos fechados</a>
          </li>
            <li class="nav-item">
...
// cria a query
$sql = "SELECT *, email, nome FROM pedidos INNER JOIN usuario ON usuario.id = pedidos.user_id WHERE user_id = '$user[id]' and (status = 'Concluido' OR status = 'Cancelado') ORDER BY criacao_pedido DESC";
...
if (mysqli_num_rows($resultado) > 0) {
  ...
  echo "<center><h4 class='text-danger' > Não há pedidos fechados! </h4></center>";
}
